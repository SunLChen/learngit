...
class MyLog{
	...
	private:
		...
		:osAppender(new log4cpp::OstreamAppender("osAppenderW",&cout))
		 ,fileAppender(new log4cpp::FileAppender("fileAppender","wxb.log"))
		{
			playout=new log4cpp::PatternLayout();
			playoutf=new log4cpp::PatternLayout();
	...
	private:
		...
		log4cpp::PatternLayout *playoutf;
